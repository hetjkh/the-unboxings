      ...
      {items.map((product) => (
        <article key={product.image} className="group flex flex-col bg-white">
          <div className="relative aspect-square w-full overflow-hidden bg-[#f5f5f5]">
            <Image src={product.image} alt={product.name} fill className="object-cover object-center transition-transform duration-500 group-hover:scale-[1.03]" sizes="(max-width: 1024px) 50vw, 25vw" />
          </div>
          <div className="flex min-h-[160px] flex-col px-4 pt-3 pb-4">
            ...
            <p className="m-0 mt-1 text-xs leading-4 text-black/50 italic">Pricing on request</p>
