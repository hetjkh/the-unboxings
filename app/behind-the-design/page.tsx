    ...
    <>
      ...
      <main>
        ...
        <section aria-labelledby="behind-design-heading" className="grid bg-[#0a0a0a] text-white lg:min-h-[calc(100svh-72px)] lg:grid-cols-[0.82fr_1.18fr]">
          <div className="flex flex-col justify-between px-5 py-12 sm:px-8 sm:py-14 md:px-16 md:py-20">
            ...
            <div className="mt-16 sm:mt-24">
              <h1 id="behind-design-heading" className="m-0 text-[clamp(2.75rem,8vw,7rem)] leading-[0.87] font-light tracking-[-0.07em] uppercase">
                {content.hero.titleLine1}<br />{content.hero.titleLine2}
              </h1>
              <p className="m-0 mt-6 max-w-[530px] border-t border-white/25 pt-5 text-sm leading-6 text-white/60 sm:mt-8 sm:pt-6 md:text-base md:leading-7">
                <FormattedText html={content.hero.description} />
              </p>
              <a href="#process" className="mt-8 inline-flex min-h-11 items-center gap-3 border-b border-white pb-2 text-[10px] font-bold tracking-[0.12em] text-white uppercase no-underline">
                {content.hero.ctaText} <span aria-hidden="true">↓</span>
              </a>
            </div>
          </div>
          <div data-motion-media className="relative flex aspect-[4/5] max-h-[70svh] items-center justify-center overflow-hidden bg-[#0a0a0a] p-4 sm:aspect-auto sm:min-h-[420px] lg:max-h-none lg:min-h-full lg:p-8">
            <ProcessImage
        ...
        <section aria-label="Our approach" className="grid border-b border-[#dedede] bg-white md:grid-cols-[0.7fr_1.3fr]">
          <div className="px-5 py-8 sm:px-8 sm:py-10 md:px-16 md:py-16">
            <p className="m-0 text-[10px] font-bold tracking-[0.1em] text-black/40 uppercase">{content.approach.label}</p>
          </div>
          <div className="border-t border-[#dedede] px-5 py-8 sm:px-8 sm:py-10 md:border-t-0 md:border-l md:px-16 md:py-16">
            <p className="m-0 max-w-[800px] text-xl leading-7 font-light tracking-[-0.035em] sm:text-2xl sm:leading-8 md:text-4xl md:leading-[1.2]">
              <FormattedText html={content.approach.quote} />
            </p>
          </div>
        </section>

        <section id="process" aria-labelledby="process-heading" className="scroll-mt-[72px] bg-white px-5 py-16 text-black sm:px-8 md:px-16 md:py-24">
          <div className="mx-auto max-w-[1440px]">
            <header className="mb-10 flex flex-col gap-5 border-t border-black pt-7 md:mb-16 md:flex-row md:items-end md:justify-between">
              <div className="min-w-0">
                <p className="m-0 text-[10px] font-medium tracking-[0.2em] text-black/40 uppercase">{content.processHeader.eyebrow}</p>
                <h2 id="process-heading" className="m-0 mt-4 text-[clamp(1.75rem,5vw,3rem)] font-light tracking-[-0.045em] uppercase md:text-5xl">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <li data-motion-card key={step.slug} className="relative grid md:grid-cols-2 md:items-stretch">
                    <div data-motion-media className={`overflow-hidden bg-[#0a0a0a] ${imageFirst ? "md:order-1" : "md:order-2"}`}>
                      <ProcessImage
                        src={step.image}
                        alt={step.alt}
                    ...
                    <div className={`flex min-h-[280px] flex-col justify-between border-r border-b border-black/20 bg-[#f1f0ec] p-5 sm:min-h-[320px] sm:p-7 md:h-full md:p-12 lg:p-16 ${imageFirst ? "md:order-2" : "md:order-1"}`}>
                      ...
                      <div className="flex flex-1 flex-col justify-center py-6 sm:py-8 md:py-10">
                        <p className="m-0 text-[10px] font-bold tracking-[0.14em] text-black/40 uppercase">{step.tagline}</p>
                        <h3 className="m-0 mt-4 text-[clamp(1.5rem,5vw,2.25rem)] font-light tracking-[-0.045em] uppercase md:text-4xl">
        ...
        <section className="grid bg-[#cbd8d4] text-black md:grid-cols-[1.4fr_0.6fr]" aria-labelledby="design-cta-heading">
          <div className="px-5 py-12 sm:px-8 sm:py-14 md:px-16 md:py-20">
            ...
            <h2 id="design-cta-heading" className="m-0 mt-4 max-w-[820px] text-[clamp(1.75rem,5vw,3rem)] leading-tight font-light tracking-[-0.04em] md:text-5xl">
